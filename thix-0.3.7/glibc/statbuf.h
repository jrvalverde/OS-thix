...
struct stat
{
    ...
    unsigned long int st_atime_usec;    /* Fractional part of st_atime.  */
    unsigned long int st_mtime_usec;    /* Fractional part of st_mtime.  */
    unsigned long int st_ctime_usec;    /* Fractional part of st_ctime.  */
