/*
 * This file is a modified version of GNU a.out.h.
 */
...
#if !defined (N_BADMAG)
#define N_BADMAG(x)     (N_MAGIC(x) != QMAGIC)
/*
    This is the general version, but Thix doesn't support anything but
    QMAGIC right now.
#define N_BADMAG(x)                                     \
...
#define _N_BADMAG(x)    (N_MAGIC(x) != QMAGIC)
/*
    Same story ...
#define _N_BADMAG(x)                                    \
 (N_MAGIC(x) != OMAGIC && N_MAGIC(x) != NMAGIC          \
