...
extern __CONSTVALUE div_t div __P ((int __numer, int __denom)) __CONSTVALUE2;
extern __CONSTVALUE ldiv_t ldiv __P ((long int __numer, long int __denom)) __CONSTVALUE2;
